...
<body class="bg-gray-50 min-h-screen flex flex-col font-sans">
    ...
    <footer class="bg-gray-800 text-gray-200 py-6 mt-12">
        <div class="container mx-auto px-4 flex flex-col items-center">
            <div class="mb-2">&copy; {{ date('Y') }} Latihan Laravel &mdash; Candra Kirana.</div>
            <div class="flex gap-4">
                <a href="https://github.com/chandafa" target="_blank" class="hover:text-white transition">GitHub</a>
                <a href="https://linkedin.com/in/candra-kirana-dev" target="_blank" class="hover:text-white transition">LinkedIn</a>
                <a href="mailto:chankirana722@gmail.com" class="hover:text-white transition">Email</a>
            </div>
        </div>
    </footer>
</body>
